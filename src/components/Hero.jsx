...
const Hero = ({ heroapi: { title, subtitle, btntext, img, sociallinks, videos } }) => {
  ...
  return (
    <>
      ...
      <div className='bg-slate-500 relative h-[100vh] w-auto flex flex-col overflow-hidden  '>
        {/*   <div className='bg-theme clip-path h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 left-0 right-0 opacity-100 z-10'></div> */}
        <div className=' h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 left-0 right-0 opacity-100 z-10'></div>
        <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container'>
          <div className='grid items-center justify-items-center mt-28 md:mt-24'>
            <h1>You must log in to be able to purchase products</h1>
            <h2 className='inline-block '>Sign up here  <Link className='text-red-500 cursor-pointer ' to="/ole">Sign Up</Link> <Link className='text-red-500 cursor-pointer ' to="/login">Log in</Link></h2>
            {/*            <h2 className='inline-block'>Login here  <Link className='text-red-500 ' to="/login">Login</Link></h2> 
 */}
